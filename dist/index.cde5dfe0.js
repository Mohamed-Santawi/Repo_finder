...
})({"50pgp":[function(require,module,exports) {
...
var _checkRadioValueJs = require("./checkRadioValue.js");
var _checkRadioValueJsDefault = parcelHelpers.interopDefault(_checkRadioValueJs);
var _elementsJs = require("./elements.js");
var _performSearchJs = require("./performSearch.js");
var _performSearchJsDefault = parcelHelpers.interopDefault(_performSearchJs);
// Start Button EventListener
(0, _elementsJs.btnElement)?.addEventListener("click", (e)=>{
    e.preventDefault();
    (0, _performSearchJsDefault.default)((0, _elementsJs.inputElement).value, (0, _checkRadioValueJsDefault.default)());
// performSearch( inputElement.value, usersInputElement.checked );
});

},{"./elements.js":"1tQBQ","./performSearch.js":"9aBgc","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./checkRadioValue.js":"zMz5E"}],"1tQBQ":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "btnElement", ()=>btnElement);
parcelHelpers.export(exports, "inputElement", ()=>inputElement);
parcelHelpers.export(exports, "cardsElements", ()=>cardsElements);
parcelHelpers.export(exports, "messageElement", ()=>messageElement);
parcelHelpers.export(exports, "loaderElement", ()=>loaderElement);
parcelHelpers.export(exports, "usersInputElement", ()=>usersInputElement);
...
parcelHelpers.export(exports, "default", ()=>function() {
        return (0, _elementsJs.messageElement).textContent;
    });
var _elementsJs = require("./elements.js");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./elements.js":"1tQBQ"}],"a8hsm":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>function(loadingState) {
        (0, _elementsJs.loaderElement).classList.toggle("hidden", !loadingState);
        loadingState && (0, _setSearchResultJsDefault.default)(null);
    });
var _elementsJs = require("./elements.js");
var _setSearchResultJs = require("./setSearchResult.js");
var _setSearchResultJsDefault = parcelHelpers.interopDefault(_setSearchResultJs);

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./elements.js":"1tQBQ","./setSearchResult.js":"2n6Nc"}],"2n6Nc":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
var _elementsJs = require("./elements.js");
const setSearchResult = (data)=>{
    let result = "";
    if (data?.length === 0) result = "<p>No results found.</p>";
    else if (data === null) result = "";
    else if (data?.length) data.map((item)=>{
        result += `
      <article class="card">
    ...
    (0, _elementsJs.cardsElements).innerHTML = result;
};
exports.default = setSearchResult;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./elements.js":"1tQBQ"}],"4lXG5":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
parcelHelpers.export(exports, "default", ()=>function(message) {
        (0, _elementsJs.messageElement).textContent = message ? message : "";
    });
var _elementsJs = require("./elements.js");

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3","./elements.js":"1tQBQ"}],"zMz5E":[function(require,module,exports) {
var parcelHelpers = require("@parcel/transformer-js/src/esmodule-helpers.js");
parcelHelpers.defineInteropFlag(exports);
...
exports.default = checkRadioValue;

},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["50pgp","jUTag"], "jUTag", "parcelRequired873")
